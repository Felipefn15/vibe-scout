...
Versão básica sem dependências complexas
"""
...
def deploy_to_railway():
    ...
    try:
        ...
        print("📝 Usando configuração simplificada (sem Playwright)")
...
def main():
    """Função principal"""
    print("🚀 Deploy Simplificado do Vibe Scout para Railway")
    print("=" * 60)
    print("📝 Versão básica sem dependências complexas")
    print("=" * 60)
    ...
    print("2. Configurar Playwright posteriormente se necessário")
